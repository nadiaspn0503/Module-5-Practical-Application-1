...
## Next Steps
Althought many observations and conclusions can be pulled from this data, it should be noted that further testing and analysis is required. For starters, missing data should be fixed before analysis, during data collection to obtain a more accurate analysis. More comparisons between demographics can and should be done. Other demographics, like free time, length of distance, and urgent destination, can be added. 
